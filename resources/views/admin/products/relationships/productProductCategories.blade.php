    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-productProductCategories">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($productCategories as $key => $productCategory)
                            <tr data-entry-id="{{ $productCategory->id }}">
                                ...
                                <td>
                                    @foreach($productCategory->categories as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-productProductCategories:not(.ajaxTable)').DataTable({ buttons: dtButtons })
