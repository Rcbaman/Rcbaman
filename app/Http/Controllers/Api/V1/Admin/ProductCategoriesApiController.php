...
class ProductCategoriesApiController extends Controller
{
    public function index()
    {
        ...
        return new ProductCategoryResource(ProductCategory::with(['product', 'categories'])->get());
    }
    ...
    public function show(ProductCategory $productCategory)
    {
        ...
        return new ProductCategoryResource($productCategory->load(['product', 'categories']));
    }
